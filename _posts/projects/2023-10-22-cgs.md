...
e0    = 4.80325e-10  # electron charge
h_pc  = 6.62606e-27  # Plank constnat; erg*s
sigT  = 6.65246e-25  # Thomson optical depth; cm**2
sigSB = 5.67040e-5   # S-B constant; erg/(s*cm**2*K**4)
kB    = 1.38065e-16  # Boltzmann constant erg/K
BQ    = 4.41e13      # Schwinger field
lamC  = 2.4240e-10   # Compton wavelength
...
<table style="width:700px">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td> $$ 2.426\times 10^{-10}$$ </td>
            <td>  </td>
            <td> $$ \mathrm{cm}$$ </td>
        </tr>
        <tr>
            <td markdown="span">Schwinger field </td>
            <td> $$B_\mathrm{Q} \equiv \frac{m_e^2 c^3}{\hbar e}$$ </td>
            <td> $$ 4.41 \times 10^{13}$$ </td>
            <td>  </td>
            <td> $$ \mathrm{G}$$ </td>
        </tr>
    </tbody>
